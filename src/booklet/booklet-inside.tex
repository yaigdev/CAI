...
\node [cardfg,below right,text width=1.96in] at (0.12in, 0.12in) {
	{\myfont
	Cards Against Infrastructure is based on Cards Against Humanity, which described itself as ``a party game for horrible people''.  Cards Against Infrastructure is not quite as mean, but still has bit of an edge.  We are big fans of the infrastructure community, and hope this game is played in a spirit of fun.  But if you don't like crude or offensive humor, this game may not be for you.}
